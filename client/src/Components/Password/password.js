    ...
    return( <><div class="pswdbody"><h1>Reset Password</h1>
        ...
        <label>
            <div class="npswd">
                ...
                <div class="npswd2"><input type = "password" value = {newpswd} onChange = {(e) => setNewpswd(e.target.value)} /><br></br></div>
            </div>
            <div class="cpswd">
                <div class="cpswd1">Confirm Password </div>
                <div class="cpswd2"><input type = "password" value = {confpswd} onChange = {(e) => setConfpswd(e.target.value)} /><br></br></div>
            </div>
        </label>
